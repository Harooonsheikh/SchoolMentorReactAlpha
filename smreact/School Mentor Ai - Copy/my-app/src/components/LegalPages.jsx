  ...
  },
  {
    ...
    content: (
      <SecBody>
        ...
        <HighlightBox icon={<i className="fa-solid fa-circle-check" />}>
  ...
  },
  {
    ...
    content: (
      <SecBody>
        ...
        <HighlightBox icon={<i className="fa-solid fa-lock" />}>
  ...
  },
  {
    ...
    content: (
      <SecBody>
        ...
        <SecPara>To generate these outputs:</SecPara>
        <BulletList items={[
          "The text, images, and documents you provide to Mentor AI are transmitted to third-party AI providers, including OpenAI and Anthropic",
          "These providers process this content solely to generate your requested response",
          "These providers do not use your content to train their models",
          "These providers are bound by confidentiality obligations consistent with this policy",
        ]} />
        <HighlightBox icon={<i className="fa-solid fa-triangle-exclamation" aria-hidden="true" style={{ color: "var(--sm-amber)" }} />}>
    ...
    content: (
      <SecBody>
        ...
        <BulletList items={[
          ...
          "AI processing services for Mentor AI features, including OpenAI and Anthropic",
        ]} />
  ...
  },
  {
    ...
    content: (
      <SecBody>
        ...
        <HighlightBox icon={<i className="fa-solid fa-comment-dots" />}>
...
const PAGES = {
  privacy: {
    ...
    metaChips: ["May 2026", "Data Protected", "No Data Selling"],
  ...
  terms: {
    ...
    metaChips: ["May 2026", "School Mentor®", "Legally Binding"],
  ...
  return (
    <a
      ...
      style={{
        ...
        // Long section titles must be allowed to break, or their min-content
        // width sets the floor for the whole sidebar column.
      ...
      <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "var(--sm-bg)", minHeight: "100vh", color: "var(--sm-text)" }}>
        ...
        <nav style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
            ...
            }}><i className="fa-solid fa-graduation-cap" aria-hidden="true" style={{ color: "#fff" }} /></div>
            <div>
          ...
          <button
            ...
            onMouseEnter={e => { e.currentTarget.style.background = "rgba(21,101,192,.14)"; e.currentTarget.style.transform = "translateX(-3px)"; }}
            onMouseLeave={e => { e.currentTarget.style.background = "rgba(21,101,192,.07)"; e.currentTarget.style.transform = "none"; }}
          >
        ...
        <div style={{
          ...
          {/* TOC Sidebar */}
          <aside style={{
            // A grid item defaults to min-width:auto, so this panel refused to
            // shrink below the min-content width of its two TOC columns and
            // pushed the page ~14px wider than the screen at 320px.
            minWidth: 0,
            ...(isTablet ? {
              display: "grid",
