...
function ModuleCard({ mod, index }) {
  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{ background: "var(--sm-surface)", border: `1.5px solid ${hov ? "rgba(21,101,192,.28)" : "var(--sm-border)"}`, borderRadius: 18, padding: "20px 16px", position: "relative", overflow: "hidden", cursor: "pointer", animation: `sosCardIn .5s ease ${0.04 + index * 0.04}s both`, transform: hov ? "translateY(-6px) scale(1.015)" : "translateY(0) scale(1)", boxShadow: hov ? "0 20px 48px rgba(21,101,192,.14), 0 0 0 3px rgba(21,101,192,.07)" : "none", transition: "transform .35s cubic-bezier(.22,.97,.47,1), box-shadow .35s ease, border-color .3s ease" }}
    >
...
export default function Tab2_OperationalManuals() {
  return (
    <>
      <style>{`
