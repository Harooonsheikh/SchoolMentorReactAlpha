...
export const EP = {
  ...
  /* ── Network Permissions — LIVE SchoolMentorSuperAdminAPI.
  ...
  networkPermissions: {
    ...
    manage: () => `${SA_ROOT}/api/SchoolPermissions/network-permissions`,
  },
